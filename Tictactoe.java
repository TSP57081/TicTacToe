	...
	System.out.println("                         NOW : ");
        ...
        for(int i=2;i<=9;i++)
		{
			...
			a=sc.nextInt();
                        if(t[a-1]!=-10)
                        {
                            System.out.println("Already Taken Dumbass!  YOU LOST!  Better luck next time! : - >");
                            System.exit(0);
                        }
                        else
                        {
                        ...
                        if(i==9)
                        {
                            ...
                            {
                            System.out.println("YOU BOTH ARE EQUALLY GENIUS....OR...");
                            System.out.println("WHO AM I TO JUDGE THO....HEHE...BBYEE  ;  >");
                            }
                        }
                }
            }
